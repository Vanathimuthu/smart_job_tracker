...
def calculate_score(resume):
    ...
    return min(100, max(15, keyword_score + detail_score + evidence_score))


def backfill_resume_scores(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("resumes", "0003_repair_resume_user_fk"),
    ]

    operations = [
        migrations.RunPython(backfill_resume_scores, migrations.RunPython.noop),
    ]
